...
describe("MVP static frontend", () => {
  ...
  it("contains working MVP hooks for the target-site-style product loop", () => {
    ...
    for (const hook of [
      ...
      "data-refresh-job",
      "data-cancel-job",
      "data-history-credit-flow",
      "data-dashboard-credit-ledger",
      "data-credit-ledger-row",
      "creditLedger",
      "recordCreditLedger",
      "mapRemoteCreditTransaction",
      "renderDashboardCreditLedger",
      "ensureDashboardCreditLedgerPanel",
      "formatCreditAmount",
      "credit-in",
      "credit-out",
      ...
      "AUTH_RETURN_KEY",
      "VIDEO_DRAFT_KEY",
      "getCurrentAuthReturnTarget",
      "getRequestedAuthReturnTarget",
      "persistAuthReturnTarget",
      "normalizeAuthReturnTarget",
      "data-next-url",
      "?next=${encodeURIComponent(returnTarget)}",
      "data-tool-workbench",
      ...
      "buildGenerationRecoveryFromJob",
      "buildGenerationRecoveryFromAsset",
      "buildGenerationRecoveryReference",
      "persistGenerationRecovery",
      "applyGenerationRecovery",
      "clearGenerationRecovery",
      "showGenerationRecoveryNotice",
      "needsReupload",
      "data-generation-recovery-notice",
      "data-dismiss-recovery",
      "data-history-recovery-hint",
      "retryJobId",
  ...
  it("contains actionable tool detail workbenches", () => {
    ...
    for (const expected of [
      ...
      "data-video-duration",
      "data-video-model",
      "data-video-upload-zone",
      "data-video-upload",
      "data-video-camera-upload",
      "data-video-upload-status",
      "data-replace-video-reference",
      "data-clear-video-reference",
      "data-video-reference-card",
      "data-video-reference-meta",
      "data-video-reference-label",
      "data-video-preflight",
      "data-video-preflight-reference",
      "data-video-preflight-spec",
      "data-video-preflight-model",
      "data-video-preflight-time",
      "data-video-preflight-output",
      "data-video-ready-state",
      "data-open-asset-picker",
      "data-asset-picker",
      "data-video-asset-search",
      "data-video-asset-filter",
      "data-video-asset-options",
      "data-trigger-reference-upload",
      "data-picker-demo-reference",
      "data-clear-asset-picker-search",
      "data-mobile-generate",
      "videoWorkflowPresets",
      "applyVideoPreset",
      "getActiveVideoPreset",
      "getVideoPreflightEstimate",
      "updateVideoPreflight",
      "normalizeVideoAspectRatio",
      "updateVideoPreviewRatio",
      "data-preview-ratio",
      "data-generated-ratio",
      "data-preview-orientation",
      "selectedVideoReference",
      "handleVideoReferenceUpload",
      "uploadVideoReferenceToSupabase",
      "updateVideoReferenceCard",
      ...
      "data-generated-download",
      "data-use-generated-output",
      "useGeneratedOutputAsReference",
      "onJobCreated",
      "data-generation-progress-actions",
      "historyHref",
      "refreshJobId",
      "cancelJobId",
      "shareAssetId",
