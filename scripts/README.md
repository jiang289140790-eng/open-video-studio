...
- `npm run verify:oauth`: creates non-redirecting Supabase OAuth authorization URLs for Google, X / Twitter OAuth 2.0, and Discord, and checks Telegram Login Widget public configuration.
