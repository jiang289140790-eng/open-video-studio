...
- The seven requested generation capabilities now have one machine-readable coverage matrix and permanent workflow IDs. A01 is fully qualified; G01, M01, O01 and F01 have direct runtime evidence; E01 has a repository-owned executable graph; P01 has an executable preset but failed its first pose-quality review. F01 remains identity-gated rather than production-ready. See [AI-WORKFLOW-002](0550-ai-engine/002-workflow-capability-matrix.md).
...
- G01 has passed direct AutoDL runtime qualification with a 25-frame MP4. M01 also produced a valid 6.15 MB image through fixed D18 inputs. P01 produced a valid 6.32 MB image through its two-reference preset, but visual review showed composition instead of proven identity-preserving pose transfer, so it remains quality-gated. All remain unpublished pending their capability-specific and complete Supabase qualification gates; AutoDL is stopped.
