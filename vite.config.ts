  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        accounts: resolve(webRoot, "accounts.html"),
        calendar: resolve(webRoot, "calendar.html"),
        analytics: resolve(webRoot, "analytics.html"),
        publishing: resolve(webRoot, "publishing.html"),
