...
- The seven requested generation capabilities now have one machine-readable coverage matrix and permanent workflow IDs. A01 is fully qualified; G01 and M01 have direct runtime evidence; E01 has a repository-owned executable graph; P01 has an executable two-reference preset but failed its first pose-quality review; O01 and F01 remain missing. See [AI-WORKFLOW-002](0550-ai-engine/002-workflow-capability-matrix.md).
