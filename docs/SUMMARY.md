...
- The seven requested generation capabilities now have one machine-readable coverage matrix and permanent workflow IDs. A01 is fully qualified; G01, M01 and O01 have direct runtime evidence; E01 has a repository-owned executable graph; P01 has an executable preset but failed its first pose-quality review; only F01 remains without an executable candidate. See [AI-WORKFLOW-002](0550-ai-engine/002-workflow-capability-matrix.md).
